        ...
        private void refreshTasklist()
        {
            ...
            foreach (Process process in processlist)
            {
                ...
                if (!String.IsNullOrEmpty(process.MainWindowTitle))
                {
                    ...
                    if (process.MainWindowTitle != "WERSI OAS" && process.MainWindowTitle != "WWSwitcher" && process.MainWindowTitle != "TaskSwitcher" && process.MainWindowTitle != "PenMount Gesture AP" && process.MainWindowTitle != "Program Manager")
                    {
